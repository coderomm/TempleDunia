<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="adddoctors.aspx.cs" Inherits="adddoctors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Add Doctors Form </h1>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                <div class="form-group has-success">
                                    <label class="control-label" for="success">Doctor Name</label>
                                    <asp:TextBox ID="Txttitle" runat="server" class="form-control"></asp:TextBox>

                                </div>

                                 <div class="form-group has-success">
                                    <label class="control-label" for="success">Post Name</label>
                                    <asp:TextBox ID="txtpost" runat="server" class="form-control"></asp:TextBox>

                                </div>

                                 <div class="form-group has-success">
                                    <label class="control-label" for="success">information</label>
                                    <asp:TextBox ID="txtinfo" runat="server" class="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>

                                </div>

                                <div class="form-group has-success">
                                    <label class="control-label" for="success">Profile Image</label>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <asp:Label ID="lblImage" runat="server" Text='<%# Eval("image") %>' Visible="false"></asp:Label>
                                                        <asp:Label ID="lblpost" runat="server" Text='<%# Eval("post") %>' Visible="false"></asp:Label>
                                                        <asp:Label ID="lblinfo" runat="server" Text='<%# Eval("info") %>' Visible="false"></asp:Label>


                                                        <td><%#Container.DataItemIndex+1%></td>
                                                    <td><%# Eval("MainCategoryName") %></td>
                                                    <td>
                                                        <img src="../img/doctorlist/<%# Eval("image") %>" style="height: 150px; width: 120px; border: solid 1px #cccccc" /></td>
