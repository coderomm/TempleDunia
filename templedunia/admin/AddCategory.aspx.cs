...
public partial class Category : System.Web.UI.Page
{
    ...
    public void list()
    {
        DataTable dt = Cnn.FillTable("select * from [M_CategoryMaster] order by MainCategoryid asc", "Detail");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Button1.Text == "Update")
        {
            ...
            if (FileUpload2.HasFile)
            {
                ...
                Bitmap bmpmain = imageHandler.CreateThumbnail(image, false, 1170, 280);
                if (bmpmain != null)
                {
                    bmpmain.Save(Server.MapPath("~/img/Mainbanner/" + filename), System.Drawing.Imaging.ImageFormat.Jpeg);
                }
            }
            if (FileUpload1.HasFile)
            {
                ...
                filename = LblId.Value + ".jpg";
                Bitmap bmpmain = imageHandler.CreateThumbnail(image, false, 300, 190);
                if (bmpmain != null)
                {

                    bmpmain.Save(Server.MapPath("~/img/MainCategory/" + filename), System.Drawing.Imaging.ImageFormat.Jpeg);
                }


                Cnn.ExecuteNonQuery("update [M_CategoryMaster] set pid='" + txtproductlink.Text.Replace("'", "''") + "',MainCategoryName='" + Txttitle.Text.Replace("'", "''") + "',image='" + filename + "' where MainCategoryid='" + LblId.Value + "' ");
            ...
            else
            {
                ...
                Cnn.ExecuteNonQuery("update [M_CategoryMaster] set pid='" + txtproductlink.Text.Replace("'", "''") + "',MainCategoryName='" + Txttitle.Text.Replace("'", "''") + "' where MainCategoryid='" + LblId.Value + "' ");
            }
        ...
        else
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                Cnn.ExecuteNonQuery("INSERT INTO [M_CategoryMaster] (MainCategoryid,MainCategoryName,image,pid) values ('" + ID + "','" + Txttitle.Text.Trim().Replace("'", "''") + "','" + filename + "','"+txtproductlink.Text+"')");
    ...
    protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "delte")
        {
            ...
            Cnn.ExecuteNonQuery("delete from [M_CategoryMaster] where MainCategoryid='" + LblId.Value + "'");
        ...
        if (e.CommandName == "active")
        {
            LblId.Value = ((HiddenField)e.Item.FindControl("HdnID")).Value;
            Cnn.Open();
            Cnn.ExecuteNonQuery("update [M_CategoryMaster] set active=1 where MainCategoryid=" + LblId.Value + "");
            Cnn.Close();
