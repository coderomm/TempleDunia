                                        ...
                                        <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../img/MainCategory/<%# Eval("image") %>" style="height: 100px; width: 140px; border: solid 1px #cccccc" />

                                                    </td><td>
                                                        <img src="../img/Mainbanner/<%# Eval("image") %>" style="height: 70px; width: 130px; border: solid 1px #cccccc" />
